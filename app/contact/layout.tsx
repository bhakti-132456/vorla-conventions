...
export const metadata: Metadata = {
  ...
  description: "Schedule a private tour or book Vorla Conventions, the best convention center in Hyderabad. Located at Saket Road, Kapra, Hyderabad 500062. Call for wedding hall, corporate event, or exhibition booking near Sainikpuri, ECIL, AS Rao Nagar, Kompally.",
  openGraph: {
