...
export const metadata: Metadata = {
  ...
  description: "Take a virtual walkthrough of Vorla Conventions' pillarless grand hall, Lakshma Reddy 1200+ capacity space, Laxmi Narsamma intimate hall, and estate landscapes in Sainikpuri, Secunderabad.",
  openGraph: {
