...
const SECTIONS = [
    {
        videoSrc: { default: `${BASE}/1-exterior.mp4`, mobile: `${BASE}/1-exterior-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/2-parking.mp4`, mobile: `${BASE}/2-parking-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/3-lobby.mp4`, mobile: `${BASE}/3-lobby-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/4-interior-bare.mp4`, mobile: `${BASE}/4-interior-bare-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/5-interior-decorated.mp4`, mobile: `${BASE}/5-interior-decorated-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/6-courtyard-lobby.mp4`, mobile: `${BASE}/6-courtyard-lobby-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/7-changing-rooms.mp4`, mobile: `${BASE}/7-changing-rooms-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/8-bridal-room.mp4`, mobile: `${BASE}/8-bridal-room-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/9-dining.mp4`, mobile: `${BASE}/9-dining-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/11-sanitation.mp4`, mobile: `${BASE}/11-sanitation-mobile.mp4` },
    ...
    {
        videoSrc: { default: `${BASE}/12-banquet.mp4`, mobile: `${BASE}/12-banquet-mobile.mp4` },
