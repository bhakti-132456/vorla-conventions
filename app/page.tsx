...
export default function Home() {
  return (
    <main className="relative bg-[var(--background)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 w-full max-w-6xl">
          <div className="flex flex-col gap-8 group">
            ...
            <div className="px-4">
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2 italic font-serif">Premium AC Function Hall in Hyderabad.</p>
              <p className="text-sm text-zinc-400 dark:text-zinc-500 mt-4 leading-relaxed max-w-sm">
          ...
          <div className="flex flex-col gap-8 group">
            ...
            <div className="px-4">
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2 italic font-serif">Outdoor Wedding Venues in Secunderabad.</p>
              <p className="text-sm text-zinc-400 dark:text-zinc-500 mt-4 leading-relaxed max-w-sm">
      ...
      <section className="min-h-screen py-20 md:py-32 px-6 bg-zinc-100 dark:bg-zinc-900 flex flex-col items-center justify-center gap-12 md:gap-16">
        <div className="text-center max-w-4xl">
          ...
          {/* dark mode text fixes applied via parent dark: */}
          <p className="text-zinc-400 mt-4 uppercase tracking-[0.2em] text-[10px]">Total Event Dominance</p>
          <p className="text-lg font-light text-zinc-500 dark:text-zinc-400 mt-8 max-w-3xl mx-auto leading-relaxed">
          ...
          {[
            ...
            >
              ...
              <div className="relative z-20 p-6 flex flex-col items-center justify-center h-full">
                ...
                <h4 className="text-xl xl:text-2xl font-light uppercase tracking-widest text-zinc-700 dark:text-zinc-200 group-hover:text-white transition-colors duration-500">
                  {item.label}
                </h4>
