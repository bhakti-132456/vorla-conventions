...
optimize "4-1-decorated-vln.mp4" "5-interior-decorated.mp4"
...
optimize "8-dining-catering.mp4" "9-dining.mp4"
optimize "9-courrtyard.mp4" "10-courtyard.mp4"
...
echo "Done! Please verify and delete original files if they were renamed."
